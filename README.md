...
Raw microbiome data were obtained from the **Qiita** public microbiome repository (https://qiita.ucsd.edu), study ID **13652**.
 
> Chen Y, Fang H, Li C, Wu G, Xu T, Yang X, Zhao L, Ke X, Zhang C. (2020).
...
> **mSphere**, 5(6), e01044-20.
> DOI: [10.1128/mSphere.01044-20](https://doi.org/10.1128/mSphere.01044-20) | PubMed: [33268567](https://pubmed.ncbi.nlm.nih.gov/33268567/)
 
The raw sequencing reads are also deposited in NCBI's Sequence Read Archive (SRA), accessible via the BioProject linked in the paper's data availability statement. Sample-level SRR accessions are listed in the Qiita sample metadata file (`mapping_file/`).
